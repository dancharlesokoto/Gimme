    ...
    <CustomSafeArea topColor="#ffffff" bgColor="#ffffff">
      <View style={styles.container}>
        ...
        <View style={{ paddingVertical: size.getHeightSize(24) }}>
          <Pressable onPress={() => router.push("/screens/FundWithCard")}>
            <View style={styles.fundContainer}>
              ...
              >
                ...
                <View style={{ marginLeft: size.getWidthSize(14) }}>
                  <Text style={styles.actionText}>Fund with Card</Text>
          ...
          <Pressable onPress={() => router.push("/screens/FundWithAirtime")}>
            <View
              style={[
            ...
            >
              ...
              >
                ...
                <View style={{ marginLeft: size.getWidthSize(14) }}>
                  <Text style={styles.actionText}>Fund with Airtime</Text>
                  <Text style={styles.actionSubText}>
                    Use your mobile airtime to get Gimme token
                  </Text>
                </View>
              </View>
              <View
          ...
          <Pressable
            onPress={() => router.push("/screens/(fund)/FundWithData")}
          >
            <View
              style={[
                styles.fundContainer,
            ...
            >
              ...
              >
                ...
                <View style={{ marginLeft: size.getWidthSize(14) }}>
                  <Text style={styles.actionText}>Fund with Data</Text>
                  <Text style={styles.actionSubText}>
                    use your data bundle to fund your account
                  </Text>
                </View>
              </View>
              <View
