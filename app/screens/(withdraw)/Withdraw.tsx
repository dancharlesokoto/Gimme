  ...
  return (
    <CustomSafeArea topColor="#ffffff" bgColor="#ffffff">
      <View style={styles.container}>
        <GenericHeader title={"Withdraw"} />
        <View style={{ paddingVertical: size.getHeightSize(24) }}>
          <Pressable onPress={() => router.push("/screens/(withdraw)/GetCash")}>
          ...
          <Pressable
            onPress={() => router.push("/screens/(withdraw)/GetAirtime")}
          >
            <View
              style={[
          ...
          <Pressable onPress={() => router.push("/screens/(withdraw)/GetData")}>
            <View
              style={[
                styles.fundContainer,
                {
