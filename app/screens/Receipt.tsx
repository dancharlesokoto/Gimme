...
import Img from "@/assets/images/receipt.png";
            ...
            <View style={styles.container}>
                ...
                <View style={styles.transaction}>
                    ...
                    >
                        ...
                        <Text style={styles.convertAmount}>{data.type}</Text>
                    </View>
                    <View
                        style={{
                            justifyContent: "space-between",
                    ...
                    >
                        ...
                        <Text style={styles.convertAmount}>{data.date}</Text>
                    </View>
                    <View
                        style={{
                            justifyContent: "space-between",
                    ...
                    >
                        ...
                        <Text style={styles.convertAmount}>{data.medium}</Text>
                    </View>
                    <View style={styles.line} />
                    <View
                        style={{
...
const styles = StyleSheet.create({
    ...
    convertAmount: {
        ...
        paddingRight: size.getWidthSize(4),
        lineHeight: 16,
        color: "#0A0B14",
    },
});
