    ...
    <CustomSafeArea topColor="#ffffff" bgColor="#ffffff">
      <View style={styles.container}>
        <View style={styles.headerContainer}>
          <Text
            style={{ fontFamily: "Satoshi-Bold", fontSize: size.fontSize(16) }}
          >
            P2P
          </Text>
          ...
          >
            <View style={styles.topContent}>
              <Svg
                ...
                // xmlns="http://www.w3.org/2000/svg"
              >
                <Rect y="1" width="93" height="93" rx="46.5" fill="#F6F6FA" />
                <Path
                ...
                <Ellipse
                  ...
                  fill="#20212D"
                />
                <Circle cx="80.3358" cy="51.2154" r="1.25055" fill="#20212D" />
                <Ellipse
                  cx="12.513"
                  cy="56.1399"
                  rx="2.13994"
              ...
              >
                Exchange your funds with other customers as Airtime, data or
                cash
              </Text>
            </View>
            ...
            <View style={styles.mainContent}>
              <View style={styles.item}>
                ...
                <View style={styles.textContainer}>
                  <Text style={styles.title}>Choose asset and place order</Text>
                  <Text style={styles.subtitle}>
                    Select an asset (Airtime, Cash, Data), Pick an Ad and place
                    your order
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.item}>
                ...
                <View style={styles.textContainer}>
                  ...
                  <Text style={styles.subtitle}>
                    Complete payment to the seller within the given time
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.item}>
                ...
                <View style={styles.textContainer}>
                  ...
                  <Text style={styles.subtitle}>
                    Once the seller confirms your payment, we will release the
                    asset to you
                  </Text>
                </View>
              </View>
