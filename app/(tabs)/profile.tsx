        ...
        <View style={styles.main}>
          ...
          <View style={styles.options}>
            <Pressable
              ...
              onPress={() => router.push("/screens/(settings)/GeneralSettings")}
            >
              <Svg
                width="40"
                height="40"
                ...
                // xmlns="http://www.w3.org/2000/svg"
              >
                <Rect width="40" height="40" rx="16" fill="#EBEFFF" />
                <Path
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.optionTitle}>General settings</Text>
            ...
            <Pressable
              style={styles.optionItem}
              onPress={() =>
                router.push("/screens/(settings)/SecuritySettings")
              }
            >
              <Svg
                width="40"
            ...
            <Pressable
              style={styles.optionItem}
              onPress={() => router.push("/screens/(settings)/HelpAndSupport")}
            >
              <Svg
                width="40"
                height="40"
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.optionTitle}>Help and support</Text>
                <Text style={styles.optionSubtitle}>
            ...
            >
              <Svg
                ...
                // xmlns="http://www.w3.org/2000/svg"
              >
                <Rect width="40" height="40" rx="16" fill="#FDEDEF" />
                <Path
