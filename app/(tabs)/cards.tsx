...
const Cards = React.memo(() => {
    ...
    return (
        <ImageBackground
            source={require("@/assets/images/cards-bg.jpeg")}
        ...
        >
            ...
            >
                ...
                <LinearGradient colors={["transparent", "#fff", "#fff"]}>
                    <View style={styles.mainContent}>
                        <View style={styles.item}>
                            ...
                            <View style={styles.textContainer}>
                                ...
                                <Text style={styles.subtitle}>
                                    Conveniently pay for your online and
                                    physical purchases
                                </Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.item}>
                            ...
                            <View style={styles.textContainer}>
                                ...
                                <Text style={styles.subtitle}>
                                    Quick card payments within our system
                                </Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.item}>
                            ...
                            <View style={styles.textContainer}>
                                ...
                                <Text style={styles.subtitle}>
                                    Use your virtual card in stores with Apple
                                    Pay or Google Pay.
                                </Text>
                            </View>
                        </View>
