        ...
        <View style={styles.container}>
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <BackPage page="Fund" />
              <Text style={styles.pageName}>Fund with airtime</Text>
            </View>
            <Country />
          </View>
          <View
          ...
          >
            <View style={{ flexDirection: "row" }}>
              ...
              >
                <Text style={styles.mainText}>Funding with airtime</Text>
                <Text style={styles.subText}>
                  Your airtime on 0813 *** **89 will be used to fund your
                  account
                </Text>
